<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="WebApplication1.cpanelPages.Registration" %>
...
<body>
    ...
    <h1>Registration</h1>
        ...
        <asp:TextBox ID="txtUsername" runat="server" Width="200px" OnTextChanged="txtUsername_TextChanged" AutoPostBack="True" ValidationGroup="password"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPassword" ErrorMessage="Enter a password" ForeColor="Red" ValidationGroup="form"></asp:RequiredFieldValidator>
        <br />
        ...
        <br />
        <asp:Button ID="Button2" runat="server" Text="Sign Up" Width="400px" OnClick="Button2_Click" ValidationGroup="form" />
    </form>
</body>
</html>
