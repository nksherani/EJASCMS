...
namespace WebApplication1.Pages
{
    public partial class Install2 : System.Web.UI.Page
    {
        ...
        public void tables()
        {
            ...
            string ddl_pages = "CREATE TABLE [dbo].[PAGES] ( [PageID] INT IDENTITY (1, 1) NOT NULL, [PageName] VARCHAR (50) NOT NULL, [DisplayName] VARCHAR (50) NULL, [DateCreated] DATETIME NULL, [DateModified] DATETIME NULL, [Published] SMALLINT NULL, [DatePublished] DATETIME NULL, [AuthorID] INT NULL, [PageURL] VARCHAR (50) NULL, CONSTRAINT [PK_PAGES_1] PRIMARY KEY CLUSTERED ([PageID] ASC), CONSTRAINT [UK_PAGES_PageName] UNIQUE NONCLUSTERED ([PageName] ASC) ); ";
