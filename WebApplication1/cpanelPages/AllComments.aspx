<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllComments.aspx.cs" MasterPageFile="~/MasterPages/Admin.Master" Inherits="WebApplication1.cpanelPages.AllComments" %>
...
<asp:Content runat="server" ContentPlaceHolderID="body">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:globaldb %>" SelectCommand="SELECT * FROM [comment_post_profiel_v]"></asp:SqlDataSource>
</asp:Content>