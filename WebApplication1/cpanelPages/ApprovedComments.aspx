<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovedComments.aspx.cs" MasterPageFile="~/MasterPages/Admin.Master" Inherits="WebApplication1.cpanelPages.ApprovedComments" %>
...
<asp:Content runat="server" ContentPlaceHolderID="body">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:globaldb %>" SelectCommand="SELECT * FROM [comment_post_profiel_v] WHERE ([Published] = @Published)">
        <SelectParameters>
            <asp:Parameter DefaultValue="1" Name="Published" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>